...
def test_account_operation():
  ...
  data = utils.read_json_file('data/models/account_operation.json')
...
def test_transaction_operation():
  ...
  data = utils.read_json_file('data/models/transaction_operation.json')
  assert utils.parse_json_model(TransactionOperation(**data)) == data

def test_account_response():
  '''Test account response model.'''

  data = utils.read_json_file('data/models/account_response.json')
